...
def poster_path(movie_id):
    if movie_id in FEATURED_POSTER_IDS:
        return f"assets/posters/{movie_id}.jpg"
    return None
...
for m in all_movies:
    search_index.append({
        ...
        "genres": m["genres"], "poster": m.get("poster"), "posterTone": m["posterTone"], "glyph": m["glyph"],
